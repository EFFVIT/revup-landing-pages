    ...
    <div id="consult">
      ...
      <footer className="consult-footer">
        ...
        <nav className="cf-links">
          ...
          {/* Same divergence as app/c/consult/page.tsx — Rev Up has no cookie
              policy page (404); its cookie disclosure is a section inside the
              privacy policy. Propagate this guard back to the fleet. */}
